...
class Database {
  ...
  async init() {
    ...
    Logger.info("MongoDB connected at: " + properties.Ldrpinsider_db_dbUrl);
 ...
 // End Init Models
  ...
  async authenticate() {
    ...
    try {
      this.dbConnection_Ldrpinsider_db = await mongoose.connect(
        "mongodb://" + properties.Ldrpinsider_db_dbUrl,
   ...
   */
  getConnection() {
    return this.dbConnection_Ldrpinsider_db;
  }
}
