...
class BranchList extends Component {
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsBranch.deleteBranch(data._id).then(() => {
        ...
        <Header>
          ...
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("BranchEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ListItem
                noIndent
                onPress={() =>
                  this.props.navigation.navigate("BranchEdit", {
                    id: item._id
                  })
                }
              >
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.BranchListReducer.listBranch
  };
}
