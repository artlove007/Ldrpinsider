...
class ProfessorList extends Component {
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsProfessor.deleteProfessor(data._id).then(() => {
    ...
    return (
      <Container>
        <Header>
          ...
          <Body>
            <Title>List Professor</Title>
          </Body>
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("ProfessorEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ListItem
                noIndent
                onPress={() =>
                  this.props.navigation.navigate("ProfessorEdit", {
                    id: item._id
                  })
                }
              >
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.ProfessorListReducer.listProfessor
  };
}
