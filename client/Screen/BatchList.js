...
class BatchList extends Component {
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsBatch.deleteBatch(data._id).then(() => {
        ...
        <Header>
          ...
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("BatchEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ListItem
                noIndent
                onPress={() =>
                  this.props.navigation.navigate("BatchEdit", {
                    id: item._id
                  })
                }
              >
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.BatchListReducer.listBatch
  };
}
